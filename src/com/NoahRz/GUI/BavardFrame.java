...
import com.NoahRz.Event.OnlineOfflineBavardEvent;
...
public class BavardFrame extends JFrame implements ActionListener, KeyListener {
    ...
    public BavardFrame(Bavard bavardLogged, Concierge concierge) {
        ...
        myMessageViewPanel.setBackground(EPapotage.myYellowColor);
    ...
    public void receiveMessages(PapotageEvent pe){
        ...
        if (pe instanceof OnlineOfflineBavardEvent){ //if we receive a OnlineOfflineBavardEvent : message that someone has just logged in or logged out
            messageBodyLabel.setText(((PapotageEvent) pe).getMessageBody());
        ...
        oneMessagePanel.setBackground(EPapotage.myYellowColor);
